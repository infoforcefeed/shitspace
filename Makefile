#############################################################################
# Makefile for building: shitspace
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  shitspace.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile shitspace.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lX11 -L/usr/include/X11 -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: shitspace.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile shitspace.pro
...
dist: 
	@test -d .tmp/shitspace1.0.0 || mkdir -p .tmp/shitspace1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/shitspace1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/shitspace1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/shitspace1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/shitspace1.0.0/ && (cd `dirname .tmp/shitspace1.0.0` && $(TAR) shitspace1.0.0.tar shitspace1.0.0 && $(COMPRESS) shitspace1.0.0.tar) && $(MOVE) `dirname .tmp/shitspace1.0.0`/shitspace1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/shitspace1.0.0
...
moc_mainwindow.cpp: /usr/include/qt5/QtWidgets/QDesktopWidget \
